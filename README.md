...
Click almost any icon on a file, folder, tab, tag, property, bookmark, or ribbon command and swap in one of 1,700+ [Lucide icons](https://lucide.dev/), 1,900+ emojis, [Simple Icons](https://simpleicons.org/) brand logos, or [Devicon](https://devicon.dev/) technology logos. Every icon can take one of nine theme colors or a custom RGB color.
...
Built on the MIT-0 licensed [Iconic](https://github.com/gfxholo/iconic) by Holo and [Better Icons](https://github.com/christianlempa/obsidian-iconic) by Christian Lempa.

## License

[MIT No Attribution](https://choosealicense.com/licenses/mit-0/). You are free to modify and share the source without crediting the author.
